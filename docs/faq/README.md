...
repository (`loan-document-intelligence`, Loan / Mortgage Document Intelligence) as a common base. Each file is
...
| [compliance-faq.md](compliance-faq.md) | Compliance / model risk | regulatory posture, PII, maker-checker, residency, model-risk evidence |
...
another repo (the guardrail gateway, the eval platform, the observability / WORM audit
sink, the human-review console, ...), the FAQ points at it and explains the boundary rather
than duplicating it. See [features-faq.md](features-faq.md) for the full "what this repo
