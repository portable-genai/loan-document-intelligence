...
text through unredacted: an unimplemented redactor must never leak applicant PII (income,
NRIC, bank data) to a model or audit sink (P-04), so porting on-premise *must* supply a
