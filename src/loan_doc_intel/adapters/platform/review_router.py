...
``HRZ_HUMAN_REVIEW_URL`` and the S2S credentials reuse this repo's shared platform S2S env vars
(``HRZ_S2S_TOKEN`` / ``HRZ_S2S_SIGNING_KEY``, sourced from ``adapters/platform/_s2s``), set on the
