...
When B5 runs inside the full Gemini Enterprise Agent Platform deployment, guardrail
...
:class:`GuardrailVerdict` (A1 contract).
...
class RemoteGuardrailError(LoanDocError):
